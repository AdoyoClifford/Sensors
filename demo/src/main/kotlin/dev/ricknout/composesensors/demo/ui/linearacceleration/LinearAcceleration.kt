...
fun LinearAccelerationDemo() {
    if (isLinearAccelerationSensorAvailable()) {
        ...
        Sensor(
            ...
            // TODO: Add demo
            val getSensor = getSensorDetails(sensorType = android.hardware.Sensor.TYPE_LINEAR_ACCELERATION)
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        painter = painterResource(id = R.drawable.ic_linear_acceleration_24dp), contentDescription = null,
